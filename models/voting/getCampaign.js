...
exports.run=(req,res,next) => {
    ...
    var sql=`SELECT c.empno,e.name,e.nominated,e.positionId,p.name AS position_name, c.image, c.message  FROM campaign AS c LEFT JOIN eligible AS e ON c.empno=e.empno LEFT JOIN position AS p ON e.positionId=p.id`;
